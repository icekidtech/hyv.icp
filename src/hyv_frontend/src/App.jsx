...
// --- IMPORTANT ---
// The following two imports are generated by `dfx deploy`. You need to run that command
// before this frontend will work. They provide the types for our canisters.
// I'm providing a placeholder so the file is valid for now.
// 
// import { idlFactory as backendIdl } from 'dfx-generated/hyv_backend';
// import { idlFactory as generatorIdl } from 'dfx-generated/hyv_generator';
const backendIdl = ({ IDL }) => IDL.Service({});
const generatorIdl = ({ IDL }) => IDL.Service({});
...
function App() {
  ...
  // Fetch datasets on actor initialization
  useEffect(() => {
  ...
  const handleGenerate = async (e) => {
    ...
    setLoading(true);
    try {
      // NOTE: Passing API key from client is insecure. This is for MVP demo purposes only.
        ...
        {!isAuthenticated ? (
          ...
          <main className="grid md:grid-cols-2 gap-12">
            ...
            <div className="flex flex-col gap-8">
              ...
              {/* NOTE: Upload form would go here in a future step */}
            </div>

            {/* Right Column: Dataset List */}
            <div className="bg-white p-6 rounded-lg shadow-md">
